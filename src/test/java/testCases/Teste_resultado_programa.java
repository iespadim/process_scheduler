...
public class Teste_resultado_programa {
    ...
    @Test
    public void teste_roda_1_programa_sem_loop_a_b_c(){
        ...
        ArrayList<Processo> testResuts = testRunner.run(testData, true, 1, 20, false);
    ...
    @Test
    public void teste_roda_1_programa_com_loop_soma_de_1_a_5(){
        TestRunner testRunner = new TestRunner();
        ArrayList<Processo> testData = new ArrayList<Processo>();
